...
import org.openinsula.arena.gwt.components.client.ui.form.field.value.BeanSuggestBoxValueHandler;
import org.openinsula.arena.gwt.components.client.ui.form.field.value.CheckBoxValueHandler;
import org.openinsula.arena.gwt.components.client.ui.form.field.value.FieldValueHandler;
import org.openinsula.arena.gwt.components.client.ui.form.field.value.HasTextValueHandler;
import org.openinsula.arena.gwt.components.client.ui.form.field.value.ListBoxValueHandler;
...
public class FieldUtilsBean {
	...
	public <T> T getValue(Widget widget) {
		...
		return fieldValueHandler != null ? (T) fieldValueHandler.getValue(widget) : null;
	}
