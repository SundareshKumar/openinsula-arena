...
public class UploadFormService implements Serializable, Service {
    ...
    private static final String RESOURCE_BUNDLE_BASE_NAME = "bundle.UploadSelectMessages";
     ...
     */
    public static final Service UPLOAD_SERVICE = JavaScriptService.forResource("Echo.UploadComponent", "/js/Upload.js");
