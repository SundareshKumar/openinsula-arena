...
implements DomUpdateSupport, ActionProcessor, PropertyUpdateProcessor, ComponentSynchronizePeer {
    ...
    public void renderHtml(RenderContext rc, ServerComponentUpdate update, Node parentNode, Component component) {
        ...
        ExtentRender.renderToStyle(style, "height", (Extent) uploadSelect.getRenderProperty(UploadSelect.PROPERTY_HEIGHT, DEFAULT_HEIGHT));
        ExtentRender.renderToStyle(style, "width", (Extent) uploadSelect.getRenderProperty(UploadSelect.PROPERTY_WIDTH, DEFAULT_WIDTH));
