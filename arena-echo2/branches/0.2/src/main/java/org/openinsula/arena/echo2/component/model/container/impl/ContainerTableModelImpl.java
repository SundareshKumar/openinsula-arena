...
public abstract class ContainerTableModelImpl<T> extends AbstractTableModel implements ContainerTableModel<T> {
	...
	/**
	 * Este método deve ser implementado para trazer um array de String com o nome das colunas
	...
	/**
	 * Este método é chamado pelo getValueAt que busca o bean do tipo T e repassa
	 * para que seja retornado o valor da propriedade de acordo com a coluna requisitada.
	 * @param columnIndex
	 * @param t
	 * @return
	 */
