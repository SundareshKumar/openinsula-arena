...
import org.openinsula.arena.validator.DefaultCpfCnpjValidator;
import org.openinsula.arena.validator.Validator;

import junit.framework.TestCase;

public class DefaultCpfCnpjValidatorTestCase extends TestCase {
	public void testValidate() {
		Validator validator = new DefaultCpfCnpjValidator();
		...
		assertTrue(validator.validate("011.189.364-00"));
		assertTrue(validator.validate("038.976.964-95"));
		assertTrue(validator.validate("001.332.345-84"));
		assertTrue(validator.validate("045.476.064-71"));
