...
import org.openinsula.arena.validator.DefaultDateValidator;
...
//        assertFalse(validator.validate(new SimpleDateFormat("dd/MM/yyyy").parse("31/04/2010")));
//        assertFalse(validator.validate(new SimpleDateFormat("dd/MM/yyyy").parse("12/30/78")));
