...
@ContextConfiguration(locations = { "classpath*:META-INF/test-context.xml", "classpath*:META-INF/mysql-datasource.xml" })
public class MysqlParameterMappingQueryTestCase extends AbstractParameterMappingQueryTestCase {
