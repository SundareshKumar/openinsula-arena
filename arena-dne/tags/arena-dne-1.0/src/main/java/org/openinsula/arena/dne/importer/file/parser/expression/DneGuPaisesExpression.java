...
public class DneGuPaisesExpression implements Expression {
	private Expression expression;

	public DneGuPaisesExpression() {
		expression = new AndExpression(new LineExpression(new CabecalhoLineFactory()), new LineExpression(
				new PaisesDadosLineFactory()).oneOrMoreTimes(), new LineExpression(new TerminadorLineFactory()));
	}
