...
public class DneGuUnidadesFederacaoExpression implements Expression {
	private Expression expression;

	public DneGuUnidadesFederacaoExpression() {
		expression = new AndExpression(new LineExpression(new CabecalhoLineFactory()), new LineExpression(
				new UnidadesFederacaoDadosLineFactory()).oneOrMoreTimes(), new LineExpression(
