...
public class DneGuCaixasPostaisComunitariasExpression implements Expression {
	private Expression expression;

	public DneGuCaixasPostaisComunitariasExpression() {
		expression = new AndExpression(new LineExpression(new CabecalhoLineFactory()), new LineExpression(
				new CaixasPostaisComunitariasDadosLineFactory()).oneOrMoreTimes(), new LineExpression(
