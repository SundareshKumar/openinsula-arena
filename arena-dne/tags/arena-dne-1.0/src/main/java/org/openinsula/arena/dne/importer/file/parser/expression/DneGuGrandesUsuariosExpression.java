...
public class DneGuGrandesUsuariosExpression implements Expression {
	private Expression expression;

	public DneGuGrandesUsuariosExpression() {
		expression = new AndExpression(new LineExpression(new CabecalhoLineFactory()), new AndExpression(
				new LineExpression(new GrandesUsuariosDadosLineFactory()), new LineExpression(
						new GrandesUsuariosEnderecoLineFactory())).oneOrMoreTimes(), new LineExpression(
