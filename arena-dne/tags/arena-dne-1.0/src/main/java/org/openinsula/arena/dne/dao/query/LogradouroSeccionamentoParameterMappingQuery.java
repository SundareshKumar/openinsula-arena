...
public class LogradouroSeccionamentoParameterMappingQuery extends MappingSqlQuery {

	public LogradouroSeccionamentoParameterMappingQuery() {
		setSql("select " + "sec.cep_sec as cep," + "sec.num_ini_trecho as inicio," + "sec.num_fim_trecho as fim,"
				+ "sec.chave_bai_dne," + "log.tipo_ofi_logradouro as tipo," + "log.preposicao as preposicao,"
				...
				+ "from " + "DNE_GU_LOGRADOUROS_SEC sec, " + "DNE_GU_LOGRADOUROS log, " + "DNE_GU_LOCALIDADES loc, "
				+ "DNE_GU_BAIRROS bai " + "where " + "sec.chave_logradouro_dne = log.chave_logradouro_dne and "
				+ "log.chave_loc_dne = loc.chave_loc_dne and " + "sec.chave_bai_dne = bai.chave_bai_dne and "
				+ "log.nome_ofi_logradouro like ? and " + "loc.nome_ofi_localidade like ? and " + "log.sigla_uf = ?");
	...
	protected Object mapRow(ResultSet rs, int rowNumber) throws SQLException {
		...
		endereco.setNumero(rs.getString("inicio"));
		endereco.setNumeroFinal(rs.getString("fim"));
