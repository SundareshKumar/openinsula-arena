...
public class DneGuUnidadesOperacionaisExpression implements Expression {
	private Expression expression;

	public DneGuUnidadesOperacionaisExpression() {
		expression = new AndExpression(new LineExpression(new CabecalhoLineFactory()), new AndExpression(
				new LineExpression(new UnidadesOperacionaisDadosLineFactory()), new LineExpression(
						new UnidadesOperacionaisEnderecoLineFactory())).oneOrMoreTimes(), new LineExpression(
