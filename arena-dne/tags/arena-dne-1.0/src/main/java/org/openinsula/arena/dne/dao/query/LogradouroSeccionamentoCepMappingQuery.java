...
public class LogradouroSeccionamentoCepMappingQuery extends MappingSqlQuery {

	public LogradouroSeccionamentoCepMappingQuery() {
		setSql("select " + "sec.cep_sec as cep," + "log.tipo_ofi_logradouro as tipo," + "log.preposicao as preposicao,"
				...
				+ "bai.nome_ofi_bai as bairro " + "from " + "DNE_GU_LOGRADOUROS_SEC sec, " + "DNE_GU_LOGRADOUROS log, "
				+ "DNE_GU_LOCALIDADES loc, " + "DNE_GU_BAIRROS bai " + "where "
				+ "sec.chave_logradouro_dne = log.chave_logradouro_dne and "
