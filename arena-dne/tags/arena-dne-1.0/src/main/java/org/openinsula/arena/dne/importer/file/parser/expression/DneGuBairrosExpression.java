...
public class DneGuBairrosExpression implements Expression {
	private Expression expression;

	public DneGuBairrosExpression() {
		expression = new AndExpression(new LineExpression(new CabecalhoLineFactory()), new LineExpression(
				new BairrosDadosLineFactory()).oneOrMoreTimes(), new LineExpression(new TerminadorLineFactory()));
	}
