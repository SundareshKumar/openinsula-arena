...
public class LogradouroComplemento1ParameterMappingQuery extends MappingSqlQuery {

	public LogradouroComplemento1ParameterMappingQuery() {
		setSql("select " + "compl.cep_compl1 as cep," + "compl.nome_compl1 as nomeComplemento,"
				...
				+ "from " + "DNE_GU_LOGRADOUROS_NUM_LOTE num, " + "DNE_GU_LOGRADOUROS_COMPL1 compl, "
				+ "DNE_GU_LOGRADOUROS log, " + "DNE_GU_LOCALIDADES loc, " + "DNE_GU_BAIRROS bai " + "where "
				+ "compl.chave_lot_dne = num.chave_lot_dne and "
				...
				+ "log.nome_ofi_logradouro like ? and " + "compl.num_lot_dne like ? and "
