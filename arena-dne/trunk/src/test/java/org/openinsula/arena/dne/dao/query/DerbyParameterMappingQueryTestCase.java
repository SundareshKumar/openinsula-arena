...
@ContextConfiguration(locations = { "classpath*:META-INF/test-context.xml", "classpath*:META-INF/derby-datasource.xml" })
public class DerbyParameterMappingQueryTestCase extends AbstractParameterMappingQueryTestCase {
