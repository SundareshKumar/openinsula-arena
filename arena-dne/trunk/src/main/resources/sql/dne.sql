CREATE TABLE DNE_GU_PAISES (
  ...
  sigla_pais_2 varchar(3) DEFAULT '',
  nome_pais_portugues varchar(72) DEFAULT '' NOT NULL,
  nome_pais_ingles varchar(72) DEFAULT '' NOT NULL,
  nome_pais_frances varchar(72) DEFAULT '',
  abrev_pais_portugues_ect varchar(72) DEFAULT '',
...
CREATE TABLE DNE_GU_UNIDADES_FEDERACAO (
  ...
  abrev_uf_rec_ect varchar(36) DEFAULT '',
...
CREATE TABLE DNE_GU_LOCALIDADES (
  ...
  abrev_loc_rec_ect varchar(36) DEFAULT '',
...
CREATE TABLE DNE_GU_BAIRROS (
  ...
  abrev_bai_rec_ect varchar(36) DEFAULT '',
...
CREATE TABLE DNE_GU_LOGRADOUROS (
  ...
  tipo_ofi_logradouro varchar(26) DEFAULT '',
  preposicao varchar(3) DEFAULT '',
  tit_pat_ofi_logradouro varchar(72) DEFAULT '',
  nome_ofi_logradouro varchar(72) DEFAULT '' NOT NULL,
  abrev_log_rec_ect varchar(36) DEFAULT '',
  info_adicional varchar(36) DEFAULT '',
...
CREATE TABLE DNE_GU_GRANDES_USUARIOS (
  ...
  abrev_gu_rec_ect varchar(36) DEFAULT '',
  tipo_ofi_logradouro varchar(72) DEFAULT '' NOT NULL,
  preposicao varchar(3) DEFAULT '',
  tit_pat_ofi_log varchar(72) DEFAULT '',
  nome_ofi_log varchar(72) DEFAULT '' NOT NULL,
  num_lote varchar(11) DEFAULT '',
  nome_compl1 varchar(36) DEFAULT '',
  num_letr_compl1 varchar(11) DEFAULT '',
  nome_compl2 varchar(36) DEFAULT '',
  num_letr_compl2 varchar(11) DEFAULT '',
  tipo_ofi_unid_ocup varchar(36) DEFAULT '',
  num_letr_unid_ocup varchar(36) DEFAULT '',
...
CREATE TABLE DNE_GU_UNIDADES_OPERACIONAIS (
  ...
  abrev_unid_oper_rec_ect varchar(36) DEFAULT '',
  ...
  num_lote varchar(11) DEFAULT '',
  nome_compl1 varchar(36) DEFAULT '',
  num_let_compl1 varchar(11) DEFAULT '',
  nome_compl2 varchar(36) DEFAULT '',
  num_let_compl2 varchar(11) DEFAULT '',
  tipo_ofi_unid_ocup varchar(36) DEFAULT '',
  num_let_unid_ocup varchar(36) DEFAULT '',
