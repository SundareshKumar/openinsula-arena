...
public class TitulosPatentesDadosLineFactory extends AbstractLineFactory {
	public TitulosPatentesDadosLineFactory() {
		...
		addField(new NumericField(3, "Chave do Título ou Patente do Logradouro no Sistema CEP"));
		addField(new NumericField(4, "Chave do Título ou Patente do Logradouro no DNE"));
		addField(new StringField(72, "Nome Oficial do Título ou Patente"));
		addField(new StringField(15, "Abreviatura do Título ou Patente recomendada pela ECT"));
