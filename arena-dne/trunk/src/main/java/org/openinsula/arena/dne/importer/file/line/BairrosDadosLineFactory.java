...
public class BairrosDadosLineFactory extends AbstractLineFactory {
	public BairrosDadosLineFactory() {
		addField(new StringField(1, "Tipo de Registro"));
		addField(new StringField(2, "Sigla da UF do Bairro"));
		addField(new NumericField(6, "Chave da Localidade do Bairro no Sistema CEP"));
		addField(new NumericField(8, "Chave da Localidade do Bairro no DNE"));
		addField(new StringField(72, "Nome oficial da Localidade do Bairro"));
		...
		addField(new StringField(36, "Abreviatura do Bairro recomendada pela ECT "));
