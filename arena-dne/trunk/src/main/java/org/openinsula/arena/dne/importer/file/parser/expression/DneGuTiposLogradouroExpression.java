...
import org.openinsula.arena.dne.importer.file.line.TiposDeLogradouroDadosLineFactory;
...
public class DneGuTiposLogradouroExpression implements Expression {
	private Expression expression;

	public DneGuTiposLogradouroExpression() {
		expression = new AndExpression(new LineExpression(new CabecalhoLineFactory()), new LineExpression(
				new TiposDeLogradouroDadosLineFactory()).oneOrMoreTimes(), new LineExpression(
