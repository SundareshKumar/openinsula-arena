...
public class LogradouroParameterMappingQuery extends MappingSqlQuery {

	public LogradouroParameterMappingQuery() {
		setSql("select " + "log.tipo_ofi_logradouro as tipo," + "log.preposicao as preposicao,"
				...
				+ "log.chave_loc_dne," + "loc.chave_loc_dne," + "loc.nome_ofi_localidade as localidade,"
