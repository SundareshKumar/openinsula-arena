...
public class LogradourosNumeracaoLoteLineFactory extends AbstractLineFactory {
	public LogradourosNumeracaoLoteLineFactory() {
		...
		addField(new StringField(86, "Separador"));
	}

	@Override
	public boolean doMatches(String s) {
		return "N".equals(getFieldString(s, 0));
	}
}
