...
public class DneGuLocalidadesExpression implements Expression {
	private Expression expression;

	public DneGuLocalidadesExpression() {
		expression = new AndExpression(new LineExpression(new CabecalhoLineFactory()), new LineExpression(
				new LocalidadesDadosLineFactory()).oneOrMoreTimes(), new LineExpression(new TerminadorLineFactory()));
	}
