...
public class LogradourosComplemento2LineFactory extends AbstractLineFactory {
	public LogradourosComplemento2LineFactory() {
		...
		addField(new NumericField(11, "Número do Lote no DNE"));
		...
		addField(new NumericField(8, "Chave do Complemento 2 no DNE"));
		addField(new StringField(1, "Separador"));
	}

	@Override
	public boolean doMatches(String s) {
		return "Q".equals(getFieldString(s, 0));
	}
}
